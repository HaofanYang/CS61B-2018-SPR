...
public class SimpleOomage implements Oomage {
    ...
    public boolean equals(Object o) {
        ...
        SimpleOomage input = (SimpleOomage) o;
        return (input.red == this.red & input.green == this.green & input.blue == this.blue);
    }
    ...
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
            ...
            return (int) ((newRed * Math.pow(10, 4)) + newGreen * Math.pow(10, 2) + newBlue);
        }
    }
